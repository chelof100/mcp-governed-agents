...
This cost is two orders of magnitude below the minimum realistic LLM
inference latency ($\approx 100\,\si{\milli\second}$ for small quantised models),
confirming that governance at the MCP layer is not a practical bottleneck.
