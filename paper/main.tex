...
A second direction is dynamic tool discovery: the current proxy
hardcodes the five P7 tools; a conformant MCP proxy should mirror
the server's tool list dynamically and apply risk scores via a
configurable policy file.
We leave both as Paper~10 of the series.
